...
describe("SwaggerDefinitionConstant", () => {
  describe("Produce", () => {
    ...
    it("expect X_WWW_FORM_URLENCODED", () => {
      expect(SwaggerDefinitionConstant.Produce.X_WWW_FORM_URLENCODED).exist;
    });
    it("expect FORM_DATA", () => {
  ...
  describe("Model", () => {
    ...
    describe("Property", () => {
      ...
      describe("Format", () => {
        it("expect INT_64", () => {
          expect(SwaggerDefinitionConstant.Model.Property.Format.INT_64).exist;
        });
      });
    });
  });
  ...
  describe("Security", () => {
    describe("Type", () => {
      it("expect BASIC_AUTHENTICATION", () => {
        expect(SwaggerDefinitionConstant.Security.Type.BASIC_AUTHENTICATION)
          .exist;
      });
      it("expect API_KEY", () => {
